...
export const projects = [
  {
    ...
    date: "Jan 2025",
    description:
      "Built a full-stack healthcare platform with role-based dashboards for patients, doctors, pharmacies, and admins, featuring real-time communication, AI-powered diagnosis, and appointment management",
  ...
  },
  {
    ...
    date: "Mar 2025",
    description:
      "Developed a full-stack personal finance platform with budget tracking, expense categorization, and interactive visual dashboards, improving user spending insights by 35%",
  ...
  },
  {
    ...
    date: "Jan 2024",
    description:
      "Classic rock-paper-scissors game built with vanilla JavaScript, HTML, and CSS. Features smooth animations and score tracking.",
  ...
  },
  {
    ...
    description:
      "Pixel-perfect clone of Amazon's homepage using HTML and CSS, demonstrating attention to detail and CSS mastery.",
